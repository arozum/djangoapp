...
urlpatterns = patterns('',
    ...
    url(
        ...
        name='login',
        kwargs={'template_name': 'templado/login.html'}
    ),
    url(
        r'^logout/$',
        'django.contrib.auth.views.logout',
        name='logout',
        kwargs={'next_page': '/templado'}
    ),
    #url(r'^login/$', 'templado.views.login_user'),
    #url(r'^logout/$', 'django.contrib.auth.views.logout',  {'template_name': 'templado/logout.html'}),
)
